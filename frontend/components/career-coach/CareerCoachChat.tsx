                            ...
                            {msg.jobs.slice(0, 3).map((job: any) => (
                              <div key={job.id} className="bg-surface border border-line/60 px-4 py-3.5">
                                ...
                                {job.application_url && job.application_url !== "#" && (
                                  <a href={job.application_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 mt-2 font-mono text-[10px] tracking-[0.05em] uppercase text-primary hover:text-primary-d transition-colors">
